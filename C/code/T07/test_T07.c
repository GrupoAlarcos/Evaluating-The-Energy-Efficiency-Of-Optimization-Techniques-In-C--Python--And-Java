...
int test_files_identical() {
    int ok1 = files_identical_ignore_opt(
        "Test1O0/07_common-subexpression-elimination-test1.c",
        "Test1O3/07_common-subexpression-elimination-test1.c"
    );

    int ok2 = files_identical_ignore_opt(
        "Test2O0/07_common-subexpression-elimination-test2.c",
        "Test2O3/07_common-subexpression-elimination-test2.c"
    );
    return ok1 && ok2;
}
