...
int test_identical_output_check_all() {
    ...
    int r1 = t1(minuend, subtrahend);
    int r2 = t2(minuend, subtrahend);
...
int test_files_identical() {
    int ok1 = files_identical_ignore_opt(
        "Test1O0/12_function-inlining-test1.c",
        "Test1O3/12_function-inlining-test1.c"
    );

    int ok2 = files_identical_ignore_opt(
        "Test2O0/12_function-inlining-test2.c",
        "Test2O3/12_function-inlining-test2.c"
    );
    return ok1 && ok2;
}
