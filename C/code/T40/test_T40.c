...
extern int ia1(int *, int, int);
extern int ia2(int *, int, int);
...
int test_files_identical() {
    int ok1 = files_identical_ignore_opt(
        "Test1O0/40_FunctionCallReduction-test1.c",
        "Test1O3/40_FunctionCallReduction-test1.c"
    );

    int ok2 = files_identical_ignore_opt(
        "Test2O0/40_FunctionCallReduction-test2.c",
        "Test2O3/40_FunctionCallReduction-test2.c"
    );
    return ok1 && ok2;
}
