...
extern bool t1(int, int, int);
extern bool t2(int, int, int);
...
int test_identical_output_check_all() {
    ...
    bool r1 = t1(r, maxN, minN);
    bool r2 = t2(r, maxN, minN);
...
int test_files_identical() {
    int ok1 = files_identical_ignore_opt(
        "Test1O0/29_Rango-test1.c",
        "Test1O3/29_Rango-test1.c"
    );

    int ok2 = files_identical_ignore_opt(
        "Test2O0/29_Rango-test2.c",
        "Test2O3/29_Rango-test2.c"
    );
    return ok1 && ok2;
}
