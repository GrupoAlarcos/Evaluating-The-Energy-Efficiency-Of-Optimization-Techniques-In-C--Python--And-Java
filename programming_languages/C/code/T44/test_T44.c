...
extern bool t1(bool, bool);
extern bool t2(bool, bool);
...
int test_files_identical() {
    int ok1 = files_identical_ignore_opt(
        "Test1O0/44_LazyEvaluation-test1.c",
        "Test1O3/44_LazyEvaluation-test1.c"
    );

    int ok2 = files_identical_ignore_opt(
        "Test2O0/44_LazyEvaluation-test2.c",
        "Test2O3/44_LazyEvaluation-test2.c"
    );
    return ok1 && ok2;
}
